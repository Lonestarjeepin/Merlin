...
Public Sub CheckAndUpdate(Optional bManual As Boolean = True)
  ...
  With mcUpdate
    ...
    .CheckURL = "https://api.github.com/repos/Lonestarjeepin/Merlin/releases?per_page=1"
    .DownloadName = "https://github.com/Lonestarjeepin/Merlin/raw/refs/heads/main/Merlin.xlam"
...
Function GetLatestGitHubRelease() As String
  Dim http As Object
  Dim json As Object
  Dim latestRelease As Object
  Dim tagName As String
  
  Set http = CreateObject("MSXML2.XMLHTTP")
  http.Open "GET", "https://api.github.com/repos/Lonestarjeepin/Merlin/releases?per_page=1", False
  http.setRequestHeader "User-Agent", "VBA"
  http.send
  
  If http.Status = 200 Then
    Set json = JsonConverter.ParseJson(http.responseText) 'I think I can kill this row since not using JsonConverter now.
    Set latestRelease = json(1)
    tagName = latestRelease("tag_name")
    GetLatestGitHubRelease = tagName
  Else
